...
type Document struct {
	ID               uuid.UUID `json:"id" gorm:"primary_key;type:uuid;default:uuid_generate_v4()"` // ID duy nhất của file
	UploaderID       string    `json:"uploader_id" db:"uploader_id"`                               // ID người đã tải file lên (tham chiếu đến User)
